...
import org.yaroslaavl.notificationservice.exception.ServiceTokenException;
...
public class TokenManager {
    ...
    @Value("${keycloak.notification-service.client_id}")
    private String clientId;

    @Value("${keycloak.notification-service.client_secret}")
    private String clientSecret;

    @Value("${keycloak.notification-service.urls.token}")
